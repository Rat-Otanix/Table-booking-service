package com.javarightnow.reservation.aspect;
...
public class BindingResultAspect {
    ...
    @Pointcut("@within(org.springframework.web.bind.annotation.RestController) && " +
            "@annotation(com.javarightnow.reservation.aspect.CheckBindingResult)")
    public void methodAcceptBindingResult() {
    }

    @Pointcut("execution(* com.javarightnow..*Controller.*(..))")
